...
declare module "vue" {
    ...
    type ScopedSlot = (props: any) => ScopedSlotChildren;
    type ScopedSlotChildren = ScopedSlotArrayContents | VNode | string | undefined;
    interface ScopedSlotArrayContents extends Array<ScopedSlotChildren> {}
    ...
    // plugin
    type PluginFunction<T> = (v: typeof Vue, options?: T) => void;
    ...
    let VueInstance: VueConstructor;
