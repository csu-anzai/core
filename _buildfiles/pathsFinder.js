...
module.exports = {
    getTsPaths: async () => {
        ...
        if (!fs.existsSync('./../../project/packageconfig.json')) {
            ...
            return glob.sync(['../../core*/module_*/scripts/**/*.ts', { ignore: ['../../core*/module_*/scripts/**/*.e2e.cypress.ts', '../../core*/module_*/scripts/**/*.unit.cypress.ts'] }])
        }
        ...
        try {
            ...
            modulesPaths = await globby(moduleMap, { ignore: ['../../core*/module_*/scripts/**/*.e2e.cypress.ts', '../../core*/module_*/scripts/**/*.unit.cypress.ts'] })
