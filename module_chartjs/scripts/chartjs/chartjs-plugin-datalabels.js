...
(function(global, factory) {
  typeof exports === "object" && typeof module !== "undefined"
    ? factory(require("chartjs"))
    : typeof define === "function" && define.amd
    ? define("chartjs-plugin-datalabels", ["chartjs"], factory)
  ...
  helpers$2.extend(HitBox.prototype, {
    ...
    contains: function(x, y) {
      ...
      return !(rx < rect.x0 || ry < rect.y0 || rx > rect.x1 || ry > rect.y1);
    }
  });
  ...
  var utils = {
    ...
    toFontString: function(font) {
      if (
        !font ||
        helpers$3.isNullOrUndef(font.size) ||
        helpers$3.isNullOrUndef(font.family)
      ) {
        return null;
      }
    ...
    parseFont: function(value) {
      ...
      var font = {
        family: helpers$3.valueOrDefault(
          value.family,
  ...
  var positioners = {
    arc: function(vm, anchor, align) {
      ...
      return aligned(vm.x + vx * d, vm.y + vy * d, vx, vy, align);
    },
    ...
    point: function(vm, anchor, align, origin) {
      ...
      return aligned(vm.x + v.x * d, vm.y + v.y * d, v.x, v.y, align);
    },
    ...
    rect: function(vm, anchor, align, origin) {
      ...
      return aligned(x, y, v.x, v.y, align);
    },

    fallback: function(vm, anchor, align, origin) {
      var v = orient(vm, origin);
      return aligned(vm.x, vm.y, v.x, v.y, align);
    }
  };
  ...
  function drawText(ctx, lines, rect, model) {
    ...
    for (i = 0; i < ilen; ++i) {
      ctx.fillText(lines[i], rasterize(x), rasterize(y), rasterize(rect.w));
