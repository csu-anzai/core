...
class Search {
    ...
    public static triggerFullSearch() {
        ...
        Ajax.genericAjaxCall("search", "renderSearch", "&search_query=" + encodeURIComponent("" + strQuery) + "&filtermodules=" + filtermodules + "&search_changestartdate=" + startdate + "&search_changeenddate=" + enddate + "&search_formfilteruser_id=" + userfilter + "", function (data : any, status : string, jqXHR : XMLHttpRequest) {
            if (status == 'success') {
