...
class TagEditor {
     ...
     */
    public static init(strElementId: string, strSource: string, initialTags : Array<string>, onChangeCallback: Function) {
        ...
        $objInput.tagEditor({
            ...
            beforeTagSave: function(field: any, editor: any, tags: Array<string>, tag: string, val: any){
                var found = false;
                $("#"+strElementId+"-list").find('input').each(function(){
            ...
            beforeTagDelete: function(field: any, editor: any, tags: Array<string>, val: any){
                $("#"+strElementId+"-list").find('input').each(function(){
                    if ($(this).data('title') == val) {
                        $(this).remove();
                    }
