...
$lang["upload_dropArea_extended"]        = "Dateien zum Upload über das Plus-Symbol wählen, per Drag n Drop hier fallen lassen oder per Copy n Paste einfügen.<br />Erlaubte Dateiendungen: {0}<br />Maximale Dateigröße je Upload: {1}";
