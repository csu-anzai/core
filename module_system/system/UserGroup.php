...
class UserGroup extends Model implements ModelInterface, AdminListableInterface, VersionableInterface
{
    ...
    {
        if ($strProperty == self::STR_ASSIGNMENT_PROPERTY && validateSystemid($strValue)) {
            $objInst = Objectfactory::getInstance()->getObject($strValue);
            if ($objInst !== null) {
                return $objInst->getStrDisplayName();
            }
        }
