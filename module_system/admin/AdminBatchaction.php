...
class AdminBatchaction
{
    ...
    public function __construct($strIcon, $strTargetUrl, $strTitle, $bitRenderInfo = false)
    {
    ...
    {
        $this->strOnClickHandler = "Lists.triggerAction('{$this->strTitle}', '{$this->strTargetUrl}', " . ($this->getBitRenderInfo() ? "1" : "0") . ");";
    }
